                    ...
                    while (ulang1) {
                        ...
                        switch (opsi) {
                            ...
                            case "5":
                                ...
                                break;
                            case "6":
                                PALE.notifKeluar(); // pemanggilan method dari implement
                                System.exit(0);
                            default:
                                PALE.notifError(); // pemanggilan method dari implement
                                break;
                        }
                    }
                    break;
                    ...
                    while (ulang1) {
                        ...
                        switch (opsi) {
                            ...
                            case "5":
                                ...
                                break;
                            case "6":
                                PANO.notifKeluar(); // pemanggilan method dari implement
                                System.exit(0);
                            default:
                                PANO.notifError(); // pemanggilan method dari implement
                                break;
                        }
                    }
                    break;
